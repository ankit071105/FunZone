...
let drawMaze = () => {
  ...
  if(currentPosition[0] == end[0] && currentPosition[1] == end[1]) {
    ...
    let curtainText = "";
    if(stage == 1)
      curtainText = "<br /><br /><h2> Stage 1 Completed Press Arrow keys to go next level !</h2>";
    else if(stage == 2)
      curtainText = "<br /><br /><h2> Stage 2 Completed Press Arrow keys to go next level </h2><br /><h3 style='color : red;'>Arrow keys inverted !</h3>";
    else if(stage == 3)
      curtainText = "<br /><br /><h2> Stage 3 Completed Press Arrow keys to go next level </h2><br /><h3 style='color : red;'>Arrow keys inverted !</h3>";
    else if(stage == 4)
