window.onload = function(){
    ...
    function startGame() {
        ...
        bgMusic.play().catch(function(e) { console.log("Error playing background music:", e); });
    }
    ...
    "use strict";
        ...
        function animateScore(scr,arrNum){
            ...
            if (scr > 0) {
                ...
                hitSound.play().catch(function(e) { console.log("Error playing hit sound:", e); });
            } else {
                var missSound = document.getElementById('missSound');
                missSound.play().catch(function(e) { console.log("Error playing miss sound:", e); });
            }
            var t = 50, l = 70, o = 1;
